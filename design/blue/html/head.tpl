    ...
    {* Include Google fonts: Montserrat & Inter *}
    ...
    fbq('init', '1366603742179922');
    fbq('track', 'PageView');
    </script>
    {/literal}
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=1366603742179922&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->

    {* Premium overlay — загружается ПОСЛЕ theme.css чтобы корректно переопределять стили *}
    <link rel="stylesheet" href="{$rootUrl}/design/{$settings->theme}/css/premium.css?v=6.0">
    <link rel="stylesheet" href="{$rootUrl}/design/{$settings->theme}/css/extra.css?v=1.2">
    
    {* Modern JS Enhancements *}
    <script src="{$rootUrl}/design/{$settings->theme}/js/pro-enhancements.js?v=1.0" defer></script>
