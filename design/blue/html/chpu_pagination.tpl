    ...
    <ul class="fn_ajax_buttons pagination{if $ajax} fn_is_ajax{/if}">
        ...
        {if $current_page_num > 1}
            <li class="pagination__item">
                <a class="fn_sort_pagination_link pagination__link" href="{if $current_page_num == 2}{furl page=null}{else}{furl page=$current_page_num - 1}{/if}" rel="prev">
        ...
        {if $current_page_num < $total_pages_num}
            <li class="pagination__item">
                <a class="fn_sort_pagination_link pagination__link" href="{furl page=$current_page_num+1}" rel="next">
