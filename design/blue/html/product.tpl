                                    ...
                                    <a href="{$image->filename|resize:1800:1800:w}" data-fancybox="we2" class="swiper-slide">
                                        <picture>
                                            ...
                                            {/if}
                                                ...
                                                <img {if $image@first} itemprop="image" {/if} src="{$image->filename|resize:600:800}" alt="{$product->name|escape}" title="{$product->name|escape}" loading="{if $image@first}eager{else}lazy{/if}" width="600" height="800"/>
                                        </picture>
                                    </a>
                                {/foreach}
                            </div>
                            ...
                            <div class="swiper-slide product-page__images-item">
                                <picture>
                                    ...
                                    {/if}
                                        ...
                                        <img class="lazy" data-src="{$image->filename|resize:60:60}" src="{$rootUrl}/design/{get_theme}/images/xloading.gif" alt="{$product->name|escape}" title="{$product->name|escape}" loading="lazy"/>
                                </picture>
                            </div>
                            {/foreach}
                        </div>
                            ...
                            {if !empty($brand->image)}
                                <div class="details_boxed__brand clearfix">
                                    <a href="{url_generator route="brand" url=$brand->url}">
                                        <img class="brand_img" src="{$brand->image|resize:120:65:false:$config->resized_brands_dir}" alt="{$brand->name|escape}" title="{$brand->name|escape}" loading="lazy" width="120" height="65">
...
"image": "{/literal}{$product->image->filename|resize:600:800}{literal}",
